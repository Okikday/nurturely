...
import 'package:nurturely/shared/helpers/extension_helper.dart';
import 'package:nurturely/shared/theme/pure_colors.dart';
...
class AppBackButton extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return IconButton(
      ...
      style: ButtonStyle(
        shape: WidgetStatePropertyAll(CircleBorder(side: BorderSide(color: PureColors.gray80))),
